...
const LoginPage:React.FC=()=>{
    return(
        <div className="h-svh flex justify-center items-center">
            <div className="w-11/12 md:w-1/3 bg-white rounded shadow-xl border-2 border-gray-100 flex flex-col justify-center items-center p-4">
                <h1 className=" text-xl font-bold my-6">ログインしてください</h1>
                <div className="my-4">
