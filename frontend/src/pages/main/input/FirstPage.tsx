    ...
    return(
        <div className="w-full">
            ...
            <div className="relative mb-12">
                ...
                <input id="understandingLevel" value={UnderstangingDefault} onChange={handleChangeUnderstanding} name="understandingLevel" type="range" defaultValue={0} min={0} max={100} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
            ...
            <div className="relative mb-12">
                ...
                <input id="confidenceLevel" value={confidenceDefault} onChange={handleChangeConfidence} name="confidenceLevel" type="range" defaultValue={0} min={0} max={100} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" />
                <span className="text-sm text-gray-500 dark:text-gray-400 absolute start-0 -bottom-6">min</span>
                <span className="text-sm text-gray-500 dark:text-gray-400 absolute start-1/2 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6"></span>
                <span className="text-sm text-gray-500 dark:text-gray-400 absolute end-0 -bottom-6">max</span>
            </div>
