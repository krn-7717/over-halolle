        ...
        <div>
            ...
            <div className="flex">
                ...
                <span className="flex items-center">
                    <span>{githubAccountAvatar?<img src={githubAccountAvatar} className="w-8 h-8 rounded-full"/>:undefined}</span>
            ...
            <div className="flex">
                ...
                <span className="flex items-center">
                    <span>{qiitaAccountAvatar?<img src={qiitaAccountAvatar} className="w-8 h-8 rounded-full"/>:undefined}</span>
